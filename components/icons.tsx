...
export const MatchesIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const SuperlikeIcon: React.FC<IconProps> = ({ className }) => (
...
export const BoostIcon: React.FC<IconProps> = ({ className }) => (
     <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const CrownIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
        <path d="M10 2a2 2 0 00-2 2v1.5a.5.5 0 01-1 0V4a4 4 0 018 0v1.5a.5.5 0 01-1 0V4a2 2 0 00-2-2zM5 6a1 1 0 00-1 1v3.268a2 2 0 00.938 1.732l2.122 1.415a.5.5 0 01.27.434V16a2 2 0 104 0v-2.15a.5.5 0 01.27-.434l2.122-1.415A2 2 0 0016 10.268V7a1 1 0 00-1-1H5z" />
    </svg>
);
...
export const AdminDatabaseIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
